...
export const spontactsReader: HtmlReader = {
  ...
  sourceUrl: ["[https://www.spontacts.com/activities?utf8=%E2%9C%93&filter%5Blocation%5D%5Bcity%5D=zuerich&filter%5Blocation%5D%5Bcity%5D=zuerich&filter%5Blocation%5D%5Bradius%5D=20.0&filter%5Blocation%5D%5Blatitude%5D=47.368648529052734&filter%5Blocation%5D%5Blongitude%5D=8.539182662963867&filter%5Bdate%5D%5B%5D=]YYYY-MM-DD",
    ...
    return [
      {
        ...
        titel:
          $detailItem.find(".activity .activity-title").text(),
        beschreibung: $detailItem.find(".activity .activity-description").text() +
